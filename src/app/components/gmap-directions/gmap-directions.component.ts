...
@Component({
  selector: 'app-gmap-directions',
  templateUrl: './gmap-directions.component.html',
  styleUrls: ['./gmap-directions.component.css'],
  providers: [GoogleMapsAPIWrapper]
})
export class GmapDirectionsComponent implements OnInit {
      ...
      autocomplete.addListener('place_changed', () => {
            this.ngZone.run(() => {
              ...
              this.vc.waypoints.push({
                location: 'Slavi-Souceck-str. 11, salzburg, austria',
                stopover: true
              });
